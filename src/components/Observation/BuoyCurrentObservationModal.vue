<template>
  <modal width="1000"
    ...
    <el-form :inline="true" :model="buoyCurrentObsForm" class="demo-form-inline"
             style="text-align:center;margin:0 auto">
      <el-form-item label="浮标">
        <el-select @change="changeLevel0LabelTemp" v-model="buoyCurrentObsForm.name" placeholder="请选择浮标" size="mini"
                   style="width:150px">
      ...
      <el-form-item label="海流层级">
        <el-select size="mini" v-model="buoyCurrentObsForm.level" style="width:210px"
      ...
      <el-form-item label="起止时间">
        <DatePicker type="datetimerange" v-model="buoyCurrentObsForm.timeRange" placeholder="开始时间-结束时间"
      ...
      <el-form-item>
        <el-button
          ...
          :loading="queryStatus"
          size="small"
          @click="queryBuoyCurrentHistory">查询
        </el-button>
      </el-form-item>
    </el-form>
