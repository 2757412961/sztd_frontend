<template>
  <div style="position: absolute;bottom:0;top:60px;right:0px;left:60px">
    ...
    <el-button @click="zoomToBuoy2" type="success" plain style="position: absolute;right:0px;top:120px;width:150px">
      2号浮标
    </el-button>
    <el-button @click="zoomToBuoy1" type="success" plain style="position: absolute;right:0px;top:160px;width:150px">
      1号浮标
    </el-button>
    ...
    <el-button @click="zoomToPlatformXiDao" type="warning" plain
               style="position: absolute;right:0px;top:280px;width:150px">西人工岛观测站
    </el-button>
    <el-button type="warning" plain style="position: absolute;right:0px;top:320px;width:150px">桂山牛头岛观测站</el-button>
